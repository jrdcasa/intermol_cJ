...
# cJ Gromacs multiple proper up to nine terms
master_paramlist['proper_multiple_dihedral'] = ['k0', 'k1', 'k2', 'k3', 'k4', 'k5', 'k6', 'k7', 'k8']
master_unitlist['proper_multiple_dihedral'] = ['energy', 'energy',
                                               'energy', 'energy',
                                               'energy',
                                               'energy',
                                               'energy',
